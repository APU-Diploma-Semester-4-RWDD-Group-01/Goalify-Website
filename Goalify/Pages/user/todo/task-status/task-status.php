...
<head>
    ...
    <script src="task-status.js" defer></script> 
...
<body>
    ...
    <nav class="side-nav">
        ...
        <ul>
            ...
            <hr>
            <a href="task-status.php"><li id="toggle-task-status">Task Status</li></a>
        </ul>
    </nav>
    
    <div class="content">
        <div id="task-status" class="active">
            <div id="past-date">
                <span class="material-symbols-rounded dropdown">chevron_right</span><strong>Past Date</strong><span class="item_count"></span>
                <div class="task"></div>
            </div>
            <div id="doing">
                <span class="material-symbols-rounded dropdown">chevron_right</span><strong>Doing</strong><span class="item_count"></span>
                <div class="task"></div>
            </div>
            <div id="done">
                <span class="material-symbols-rounded dropdown">chevron_right</span><strong>Done</strong><span class="item_count"></span>
                <div class="task"></div>
            </div>
